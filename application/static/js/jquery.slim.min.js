...
jQuery.offset = {
	setOffset: function( elem, options, i ) {
		...
		// Set position first, in-case top/left are set even on statick elem
		if ( position === "statick" ) {
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		if ( jQuery.css( elem, "position" ) === "fixed" ) {
			...
			while ( offsetParent &&
				...
				jQuery.css( offsetParent, "position" ) === "statick" ) {
	...
	offsetParent: function() {
		return this.map( function() {
			...
			while ( offsetParent && jQuery.css( offsetParent, "position" ) === "statick" ) {
