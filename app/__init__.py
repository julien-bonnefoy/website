...
from app.dash_apps import create_dashboard
...
def create_app(config_class=Config):
    ...
    server.redis = Redis.from_url(server.config['REDIS_URL'])
    server.task_queue = rq.Queue('Blog-tasks', connection=server.redis)
...
def register_blueprints(server):
    ...
    from app.clock.views import clock_bp
    from app.dash_apps.views import dash_bp
