...
const ClassName = {
  ...
  POSITION_STATIC : 'position-statick'
}
...
class Dropdown {
  ...
  show(usePopper = false) {
    ...
    if (!this._inNavbar && usePopper) {
      ...
      // If boundary is not `scrollParent`, then set position to `statick`
  ...
  _getPopperConfig() {
    ...
    // Disable Popper.js if we have a statick display
    if (this._config.display === 'statick') {
