...
function expandTicks(clock, delay) {
...
function showClocks() {
  for (let i=0; i < clocksIds.length; i++) {
    ...
    let clock = document.getElementById("clockface--" + clocksIds[i]);
    let label = document.getElementById("label--" + clocksIds[i]);
    setTimeout(function() {
      showTicks(clock, delay)
...
function appendParis() {
  paris = document.getElementById('clockface--23')
