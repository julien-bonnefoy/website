    ...
    for dashapp in dashapp_list:
        ...
        callback_function = getattr(
             importlib.import_module(
                 'app.dash_apps.' + dashapp['name'] + '.' + dashapp['callback_file']), dashapp['callback_function'])

        layout_function = getattr(
            importlib.import_module(
                 'app.dash_apps.' + dashapp['name'] + '.' + dashapp['layout_file']), dashapp['layout_function'])
